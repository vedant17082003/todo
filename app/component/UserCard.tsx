...
export function CardDemo({ username, name }: User) {
    return (
        <Card>
    ...
    return (
        <div className="p-4 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                ...
                <Container className="h-6 w-6 circle-2">
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "max-w-sm w-full mx-auto p-4 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-black shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group mt-7",
                className
            )}
        >
            {children}
...
export const CardDescription = ({
    ...
    return (
        <p
            className={cn(
                "text-sm font-normal text-white dark:text-neutral-400 max-w-sm",
                className
            )}
        >
            {children}
